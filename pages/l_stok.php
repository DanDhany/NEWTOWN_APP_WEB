                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php 
										$cari = mysqli_query($conn, "select a.kode, a.nama, a.satuan, a.hjual, a.hbeli, a.jumlah, (select sum(b.jumlah) from tbldetail_jual b where b.kode=a.kode) as \"Jual\", (select sum(c.jumlah) from tbldetail c where c.kode=a.kode) as \"Beli\" from tbbarang a ");
										...
										$jual = $row['Jual'];
										$beli = $row['Beli'];
										$total = $row['jumlah']-$row['Jual']+$row['Beli'];
										$_SESSION['kode'] = $kode;
										$_SESSION['nama'] = $nama;
										$_SESSION['satuan'] = $satuan;
										$_SESSION['hjual'] = $hjual;
										$_SESSION['hbeli'] = $hbeli;
										...
										echo "</td>";
										echo "<td>";
										echo $_SESSION['jumlah']." ".$_SESSION['satuan'];
										echo "</td>";
										echo "<td>";
										echo $_SESSION['jual']." ".$_SESSION['satuan'];
										echo "</td>";
										echo "<td>";
										echo $_SESSION['beli']." ".$_SESSION['satuan'];
										echo "</td>";
										echo "<td>";
										echo $_SESSION['jumlah']-$_SESSION['jual']+$_SESSION['beli']." ".$_SESSION['satuan'];
										echo "</td>";
									}
							...
							<div class="col-lg-2">
							<a href="cetak_stok.php" class="btn btn-lg btn-warning btn-block">Print</a>
							</div>
                        </div>
                        <!-- /.panel-body -->
                    </div>
