...
$datasup=$_SESSION["datasup"];
$dataalmt=$_SESSION["dataalmt"];
$datatlp=$_SESSION["datatlp"];
$totalakhir=$_SESSION["total"];
$diskonakhir=$_SESSION["diskon"];
$sqlk = "INSERT INTO tblmaster(kodetr, tanggal, supplier, alamat, telpon, total,
diskon) VALUES('$datatr','$datatgl','$datasup','$dataalmt','$datatlp',$totalakhir,$diskonakhir) " ;
...
$sqld = "INSERT INTO tbldetail(kodetr, kode, nama, satuan, jumlah, harga)
...
$sqlc = "select count(*)as jum from tblmaster";
...
<table align="center">
<tr><td colspan="2"><h1>Transaksi Pembelian</h1></td></tr>
...
<br />
<tr><td>Supplier</td><td><select name="sup" id="sup" onchange="detailSup(this.value)" >
<option value=""  selected><?php if(isset(
$_SESSION['datasup'])){  echo $_SESSION['datasup'];} else{?>Pilih Supplier<?php }?></option>
<?php
...
$muncul.= "detail1['" . $data1['nama'] . "'] = {no_telp:'" . addslashes($data1['no_telp']) . "',alamat:'".addslashes($data1['alamat']). "'};\n";
}
?>
...
$_SESSION['datatlp'])){ echo $_SESSION['datatlp'];} ?>"  required></td></tr><br>
<tr><td>Alamat</td>
<td> <input type="text" name="alamat" id="alamat" value="<?php if(isset(
$_SESSION['dataalmt'])){ echo $_SESSION['dataalmt'];} ?>" required></td></tr><br>
<script type="text/javascript">    
    <?php echo $muncul; ?>  
    function detailSup(sup){  
    document.getElementById('no_telp').value = detail1[sup].no_telp;
	document.getElementById('alamat').value = detail1[sup].alamat;
    };  
</script><br />
<br />
</table>
...
$nama.= "detail['" . $data['nama'] . "'] = {kode:'" . addslashes($data['kode']) . "',harga:'".addslashes($data['hbeli']). "' ,satuan:'".addslashes($data['satuan']). "'};\n";
}
?>
</select></td>
...
echo
"<tr><td>Kode Barang</td><td>Nama Barang</td><td>Satuan</td><td>Jumlah</td><td>Harga</td><td>Total</td></tr>";
$total=0;
