...
$query = mysqli_query($conn,"select * from tblmaster_jual where kodetr='$kodetr'");
...
$pdf->setfont('Arial','B',10);
 ...
 $pdf->cell(70,6,'Pelanggan : '.$master['pelanggan'],0,1);
...
$tbbarang=mysqli_query($conn, "select * from tbldetail_jual where kodetr='$kodetr'");
