                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="center">
                           <b> Selamat Datang Di Aplikasi ! </b>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
						<h2 align="center" class="page-heading"><img width="150px"  src="newtown.png"> New Town App</h2>
			...
			<div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <a href="m_barang.php">
                            <div class="panel-footer">
                                <span class="pull-left">Tambah Produk</span>
				...
				<div class="col-lg-3 col-md-6">
                    <div class="panel panel-info">
                        ...
                        <a href="m_pengguna.php">
                            <div class="panel-footer">
                                <span class="pull-left">Tambah Pengguna</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">Ada</div>
                                    <div>Supplier Baru?</div>
                                </div>
                            </div>
                        </div>
                        <a href="m_supplier.php">
                            <div class="panel-footer">
                                <span class="pull-left">Tambah Supplier</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                        ...
                        <a href="t_penjualan.php">
                            <div class="panel-footer">
                                <span class="pull-left">Transaksi Penjualan</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
				...
				<div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <a href="t_pembelian.php">
                            <div class="panel-footer">
                                <span class="pull-left">Transaksi Pembelian</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-default">
                        ...
                        <a href="l_stok.php">
                            <div class="panel-footer">
                                <span class="pull-left">Laporan Stok</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">Cetak</div>
                                    <div>Pemasukan?</div>
                                </div>
                            </div>
                        </div>
                        <a href="l_penjualan.php">
                            <div class="panel-footer">
                                <span class="pull-left">Laporan Penjualan</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
				...
				<div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        ...
                        <a href="l_pembelian.php">
                            <div class="panel-footer">
                                <span class="pull-left">Laporan Pembelian</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
