...
$query_count = mysqli_query($conn,"select sum(total) as total from tblmaster");
...
$pdf->Cell(70,6,'',0,1);
$pdf->Cell(70,6,'Total Transaksi Pembelian  :  Rp. '.$jumlah['total'].",-" ,0,1);
