						...
						<form action="" method="POST">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
									...
									$tgl = mysqli_query($conn, "select tanggal from tblmaster_jual where tanggal between '$mulai' and '$selesai'");
									$cari = mysqli_query($conn, "select * from tblmaster_jual where tanggal between '$mulai' and '$selesai'");
									...
									while ($row = mysqli_fetch_array($cari)){
										...
										echo "<tr> <form method=\"post\" action=\"cetak_detail_jual.php\">";
									...
									<tfoot>
										<?php
										$results = mysqli_query($conn, "SELECT  SUM(total) AS total FROM tblmaster_jual where tanggal between '$mulai' and '$selesai'");
									...
									$cari1 = mysqli_query($conn, "select * from tblmaster_jual ");
									...
									<tfoot>
										<?php
										$results = mysqli_query($conn, "SELECT  SUM(total) AS total FROM tblmaster_jual ");
										while ($row = mysqli_fetch_array($results)) {
										?>
									  <tr>
										<th></th>
									...
									$cari = mysqli_query($conn, "select * from tblmaster_jual ");
									while ($row = mysqli_fetch_array($cari)){
										$kode = $row['kodetr'];
										$nama = $row['tanggal'];
										$pel = $row['pelanggan'];
